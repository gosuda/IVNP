...
func TestCloveSetRoundTrip(t *testing.T) {
	message := foundation.I2NPMessage{Header: foundation.I2NPHeader{Type: foundation.I2NPDeliveryStatus, ID: 1}, Payload: make([]byte, 12)}
	...
	if err != nil || !ok || clove.ID != 9 || clove.Message.Header.Type != foundation.I2NPDeliveryStatus {

...
func (h *HybridInitiator) EncryptE1(state *dataplanenoise.SymmetricState, dst []byte) ([]byte, error) {
	if h == nil || state == nil {
		return nil, ErrHybrid
	}
...
func (h *HybridInitiator) ConsumeEKEM(state *dataplanenoise.SymmetricState, dst, ciphertext []byte) error {
...
func (h *HybridResponder) ConsumeE1(state *dataplanenoise.SymmetricState, dst, ciphertext []byte) error {
...
func (h *HybridResponder) EncryptEKEM(state *dataplanenoise.SymmetricState, dst []byte) ([]byte, error) {

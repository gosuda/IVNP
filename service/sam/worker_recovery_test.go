...
func (e *panicSendEndpoint) SendMessage(context.Context, streamtunnel.Delivery) error {
...
func TestSAMWorkerPanicContainmentAndCleanup(t *testing.T) {
	...
	t.Run("datagram receive", func(t *testing.T) {
		...
		message := clientapi.NewReceivedMessage(streamtunnel.Delivery{Payload: []byte("owned")}, nil)

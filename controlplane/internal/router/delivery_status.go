...
func (m *DeliveryStatusMux) HandleDeliveryStatus(status foundation.I2NPDeliveryStatusMessage) bool {
	if m == nil {
		return false
	}
...
func (m *DeliveryStatusMux) Sink(status foundation.I2NPDeliveryStatusMessage) error {

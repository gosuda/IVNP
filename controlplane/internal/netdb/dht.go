...
func (t *Table) Store(info foundation.NetworkDatabaseRouterInfo, floodfill bool, seenAt uint64) error {
...
func (t *Table) StoreVerified(info foundation.NetworkDatabaseRouterInfo, floodfill bool, seenAt uint64) {
	hash := info.Hash()
